...
walletAddr=$(cat ~/$BLOCKCHAIN_PREFIX/buyer.addr)
signingKey1=~/$BLOCKCHAIN_PREFIX/buyer.skey
signingKey2=~/$BLOCKCHAIN_PREFIX/buyer.skey
value="1 $(cat $baseDir/minter-duplicate-owner-id.txt).746F6B656E"
mintScript=scripts/minter-duplicate-owner.plutus
